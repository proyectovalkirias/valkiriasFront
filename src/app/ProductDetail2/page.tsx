...
import BuzoOversize from "../../../public/images/BuzoOversize.jpg";
    ...
    <div className="h-screen bg-purple-100 flex items-center py-8 px-4">
      <div className="flex mx-16 gap-4 h-[600px] w-1/2">
        <div className="flex flex-col gap-4 w-1/2">
          <img
            src="https://th.bing.com/th/id/OIP.3zxlkdT9kHDHDhduW7u8FgAAAA?rs=1&pid=ImgDetMain"
            alt="Remera 1"
      ...
      <div className="w-1/2 max-w-4xl text-center p-6">
        ...
        <div className="mb-6 flex gap-4 text-center justify-start allign-center">
          <label className=" text-gray-800 mt-1 font-medium text-lg mb-2">
            Opciones de estampado:
          </label>
        ...
        <div className="mb-6 flex gap-4 text-center justify-start allign-center">
          <label className="block mt-1 text-gray-800 font-medium text-lg mb-2">
            Selecciona un color:
          </label>
        ...
        {/* Campo para ideas */}
        <textarea
          className="border flex w-1/2 border-gray-300 text-gray-800 rounded-lg p-3 h-12 mb-4"
